			...
			<tr>
				...
				<table style="width: 100%;height:92px;">
					<tr>
						...
						<a href="{site}index.php/stat">Топ PvP</a>
						<a href="{site}index.php/stat/liders">Лидеры рас</a>
						<a href="{site}index.php/stat/hours">Онлайн по часам</a>
						<a href="{site}/stat/banlist">Бан лист</a>
						</div></td>
						<td>
